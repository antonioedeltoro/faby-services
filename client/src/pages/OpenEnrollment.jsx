...
export default function OpenEnrollment() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailSubject = encodeURIComponent(`Open Enrollment Inquiry: ${subject}`);
      ...
      <section className="open-enrollment-section">
        <div className="enrollment-content">
          ...
          <ul className="enrollment-list">
            ...
            <li>Or fill out our online contact form, and we'll call you at your convenience.</li>
          ...
          <form className="enrollment-form" onSubmit={handleSubmit}>
            ...
            <label>
              ...
              <input type="datetime-local" name="callAt" value={formData.callAt} onChange={handleChange} />
            </label>
            ...
            <div className="enrollment-buttons">
              ...
              <button type="button" className="button button--outline" onClick={handleReset}>Clear Form</button>
            </div>
          </form>
        </div>
      </section>
